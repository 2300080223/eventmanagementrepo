      ...
      <nav className="navbar">
         <div className="logo">
          ...
          <span className="logo-text">
            Elevate <span className="highlight">Events</span>
          </span>
        </div>
        <ul className="nav-links">
          ...
          <li className="dropdown">
            ...
            <ul className="dropdown-menu">
              <li><Link to="/addproduct">Add Event</Link></li>
              <li><Link to="/viewallproducts">View All Event</Link></li>
              <li><Link to="/displayproducts">Display All Event</Link></li>
            </ul>
          </li>
